...
if __name__ == '__main__':
    ...
    test, _ = load_data("./week_10_test_data.csv", is_train=False)
    ...
    # print(AgodaCancellationEstimator().model)
    ...
    # estimator.fit(X, y)
    # df = estimator.loss_multiple(samples)
    # df.to_csv(f'./results/comparison_neural_network - all weeks - max_iter 500.csv', index=False)
